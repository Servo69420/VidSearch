    ...
    <div className="legal-page">
      ...
      <section className="section legal-content">
        <div className="container legal-container">
          ...
          <p>Your information is used to provide and personalize the VideoSearch service, including generating AI-powered explanations, recommending content, and tracking your learning progress. We do not sell your personal data to third parties.</p>
          ...
          <h4>6. Cookies</h4>
          <p>We use essential cookies to maintain your session and preferences. Analytics cookies help us understand how you use VideoSearch so we can improve the experience. You can manage cookie preferences in your browser settings.</p>

          <h4>7. Contact</h4>
          <p>If you have questions about this policy, contact us at privacy@videosearch.com or through our <a href="#/contact">contact page</a>.</p>
        </div>
      </section>
    </div>
  )
