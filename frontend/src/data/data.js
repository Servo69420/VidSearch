...
export const ALL_VIDEOS = [
  ...
  { id: 3,  title: 'Object-oriented programming',     subject: 'CS Fundamentals', duration: '7:20',  color: 'thumb-navy',   icon: '\u25FB', youtubeId: 'SiBw7os-_zI', description: 'Learn the four pillars of OOP: encapsulation, inheritance, polymorphism, and abstraction.' },
  ...
  { id: 6,  title: 'Cell division explained',         subject: 'Biology',         duration: '4:45',  color: 'thumb-teal',   icon: '\u2295', youtubeId: 'GHIlA76-h3c', description: 'Mitosis and meiosis explained with clear visuals and real-world examples.' },
  ...
  { id: 9,  title: 'Statistics fundamentals',         subject: 'Mathematics',     duration: '6:55',  color: 'thumb-gold',   icon: '\u221E', youtubeId: 'SzZ6GpcfoQY', description: 'Mean, median, standard deviation, and probability distributions made simple.' },
  ...
  { id: 11, title: 'The rise of the Roman Empire',    subject: 'History',         duration: '11:20', color: 'thumb-rose',   icon: '\u2694', youtubeId: 'bTEAVBNc4DU', description: 'How Rome grew from a small city-state to the greatest empire of the ancient world.' },
  { id: 12, title: "Newton's laws of motion",         subject: 'Physics',         duration: '6:30',  color: 'thumb-sky',    icon: '\u229B', youtubeId: 'qgIm96-WkwY', description: 'The three laws that govern all motion, explained with everyday examples.' },
  { id: 13, title: 'Quantum mechanics intro',         subject: 'Physics',         duration: '10:05', color: 'thumb-sky',    icon: '\u2B21', youtubeId: 'JP9KP-fwFhk', description: 'Wave-particle duality, superposition, and the uncertainty principle demystified.' },
  { id: 14, title: 'Thermodynamics explained',        subject: 'Physics',         duration: '7:15',  color: 'thumb-sky',    icon: '\u25C8', youtubeId: '4i1MUWJoI0U', description: 'The laws of thermodynamics and how energy flows through systems.' },
  ...
  { id: 17, title: 'Natural language processing',     subject: 'Machine Learning',duration: '9:25',  color: 'thumb-violet', icon: '\u2297', youtubeId: 'CMrHM8a3hqw', description: 'From tokenization to transformers: how machines understand human language.' },
]
